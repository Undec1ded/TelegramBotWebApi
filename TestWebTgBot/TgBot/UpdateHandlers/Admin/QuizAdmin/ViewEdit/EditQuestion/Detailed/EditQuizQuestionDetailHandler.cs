...
public class EditQuizQuestionDetailHandler : IUpdateHandler
{
    private readonly TelegramBot _telegramBot;
    private readonly IQuizService _quizService;

    public EditQuizQuestionDetailHandler(
    ...
    public bool CanHandle(Update update)
    {
        ...
        {
            return update.CallbackQuery.Data.StartsWith("EditQuizQuestion_");
        }
        return false;
    }
