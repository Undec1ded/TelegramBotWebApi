...
public class EndVotingHandler : IUpdateHandler
{
    private readonly TelegramBot _telegramBot;
    private readonly IAdminService _adminService;

    public EndVotingHandler(TelegramBot telegramBot, IAdminService adminService)
    {
    ...
    public async Task HandleUpdateAsync(Update update)
    {
        ...
        lastVoting.IsStart = false;
        lastVoting = await _adminService.SetVotingEndAsync(lastVoting);
    ...
    public bool CanHandle(Update update)
    {
        ...
        {
            return update.CallbackQuery.Data == "EndVotingAdmin";
        }
        return false;
    }
}